...
export const getPresetRules = (preset: ArchitecturePreset): {
        ...
        boundaries: [
          {
            ...
            severity: 'error',
            message:
              'Feature modules must not import from other features. Extract shared code to shared/ or core/.',
          },
          {
            from: 'src/app/shared/**',
            disallowImportFrom: ['src/app/features/**'],
        ...
        publicApi: [
          {
            ...
            severity: 'warning',
            message:
              "Import from the feature's public API (index.ts) instead of internal files.",
          },
          {
            zone: 'src/app/shared/*',
            onlyAllowImportFrom: ['index.ts'],
            severity: 'warning',
            message:
              "Import from the shared module's public API (index.ts) instead of internal files.",
          },
        ],
        deepImports: [
          {
        ...
        boundaries: [
          {
            ...
            severity: 'error',
            message:
              'Domain modules must not import from other domains. Use shared interfaces or a mediator.',
          },
          {
            from: 'src/app/domains/**',
            ...
            severity: 'warning',
            message:
              'Domain modules should not depend directly on infrastructure. Use dependency inversion.',
          },
        ],
        publicApi: [
          {
