...
export const getScoreLabel = (score: number): string => SCORE_LABELS.find((s) => score >= s.min)?.label ?? "Critical";
...
/** Per-rule deduction caps. Rules not listed here are uncapped within their category ceiling. */
