...
export const isCoreDiagnostic = (diagnostic: Pick<Diagnostic, 'trust'>): boolean =>
  diagnostic.trust === 'core';

export const shouldIncludeInScore = (
  diagnostic: Pick<Diagnostic, 'trust'>,
  profile: ScanProfile,
): boolean =>
...
export const classifyDiagnostic = (
  ...
  const provenance =
    ...
    inferDiagnosticProvenance(diagnostic);
