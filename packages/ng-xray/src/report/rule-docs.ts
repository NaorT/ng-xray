...
export const RULE_DOCS: Record<string, RuleDoc> = {
  ...
  'deep-import': {
    rule: 'deep-import',
    title: 'Deep Import Between Features',
    category: 'architecture',
    whyItMatters: 'Features importing directly from other features creates tight coupling. Changes in one feature can break unrelated features.',
    beforeCode: `import { helper } from '../../other-feature/utils/helper';`,
    afterCode: `import { helper } from '@shared/utils/helper'; // Move shared code to shared/`,
    effort: 'moderate',
    estimatedMinutes: 20,
